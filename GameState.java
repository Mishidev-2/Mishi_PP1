public class GameState {
    ...
    // HOW TO USE: Check if player has set a custom name
    ...
    // HOW TO USE: Check or set the taint status effect
    ...
    // HOW TO USE: Check or set Ed3 status (affects dialogue choices in Mission 1)
    // CHECK: if (GameState.isIfEd3()) { ... }
    // SET: GameState.setIfEd3(true);
    private static boolean ifEd3 = false;
    
    // HOW TO USE: Check or set Ed2 status (used for Bad End 2 in Mission 4)
    // CHECK: if (GameState.isIfEd2()) { ... }
    // SET: GameState.setIfEd2(true);
    private static boolean ifEd2 = false;
    
    // HOW TO USE: Check or set feather possession (affects Mission 3 & 4 paths)
    // CHECK: if (GameState.hasFeather()) { ... }
    ...
    /**
     * Set whether name has been configured
