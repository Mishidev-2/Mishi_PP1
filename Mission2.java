...
public class Mission2 {
   ...
   public static void start() {
      ...
      while (!missionCompleted) {
         ...
         GameTools.typeText("=============== HELL ================", ConsoleColors.RED_BOLD);
         GameTools.delay(2.5);
         GameTools.clearScreen();
...
//LScene 1
         ...
         GameTools.delay(1);
         GameTools.typeText("The silence is its own kind of instruction.", ConsoleColors.PURPLE, 50);
         GameTools.delay(0.5);
...
//LScene 2
         ...
         GameTools.delay(0.7);
         GameTools.typeText("A child's cry.", ConsoleColors.CYAN_BOLD, 100);
         GameTools.typeText("\n\n");
         GameTools.delay(1);
...
// LChoice 1 - Sin counter increment
         ...
         switch (choice) { 
            case "2" -> {
                ...
                GameTools.typeText("\n");
                GameTools.typeText("wrapping around the soul and pulling it gently into the depths.", ConsoleColors.RED);GameTools.delay(0.5);
              }
            default -> {
               if(!choice.equals("1")){
                  GameTools.typeText("Invalid choice.", ConsoleColors.RED);
                  GameTools.delay(0.5);
                  GameTools.typeText("\nIgnoring by default");
                  GameTools.delay(0.5);
               }
                ...
                GameTools.typeText("\n");
                GameTools.delay(1);
                GameTools.typeText("Forever.", ConsoleColors.RED_BOLD, 100);
                GameTools.delay(0.5);
              }
         }         
         GameTools.typeText("\n\nSin counter: " + GameState.getSinCounter(), ConsoleColors.RED);         
...
// LScene 3
         ...
         GameTools.typeText("\nIts voice drips like oil across still water.", ConsoleColors.PURPLE);GameTools.delay(0.5);
         GameTools.delay(1);
...
// LChoice 2 - Riddle game
         ...
         while (!riddleSolved) {
            GameTools.typeText("\"In a realm where no heart beats, ", ConsoleColors.CYAN);GameTools.delay(0.2);
            GameTools.typeText("I am born without breath.\n", ConsoleColors.CYAN);GameTools.delay(0.5);
            GameTools.delay(0.7);
            GameTools.typeText("My voice breaks silence, ", ConsoleColors.CYAN);GameTools.delay(0.2);
            GameTools.typeText("yet I have no mouth.\n", ConsoleColors.CYAN);GameTools.delay(0.5);
            GameTools.delay(0.7);
            GameTools.typeText("I am the echo of what was never given life, ", ConsoleColors.CYAN);GameTools.delay(0.2);
            GameTools.typeText("\n");
            GameTools.typeText("and the memory of a name never spoken.\n\n", ConsoleColors.CYAN);GameTools.delay(0.5);
            GameTools.delay(1.5);

            GameTools.typeText("What am I?\"\n: ", ConsoleColors.WHITE_BOLD, 100);GameTools.delay(0.5);
            ...
            if (GameTools.checkRiddleAnswer(answer, riddle1Keywords)) {
               ...
               GameTools.delay(0.5);
               GameTools.delay(1);
               GameTools.typeText("forever crying for a world that never heard them.\"", ConsoleColors.CYAN, 100);GameTools.delay(0.5);
               riddleSolved = true;
            } else {
               //Fail
               GameTools.typeText("\nThe gatekeeper's eyes dim.\n", ConsoleColors.RED);GameTools.delay(0.5);
               GameTools.delay(0.5);
               ...
               GameTools.typeText("<???>\n");
               GameTools.delay(0.5);
               GameTools.typeText("\"Why did you not know us?\"\n\n", ConsoleColors.CYAN_BOLD, 100);GameTools.delay(0.5);
               GameTools.delay(1);
         ...
         if (!riddleSolved) {
            ...
            GameTools.typeText("\nDissolved into dust...", ConsoleColors.RED);
            GameTools.delay(2);
            GameTools.typeText(" Reforming...", ConsoleColors.GREEN);
            GameTools.delay(2);
...
// GScene 1
      ...
      GameTools.delay(1.5);
      GameTools.typeText("Then you see it.\n\n", ConsoleColors.RED_BOLD);GameTools.delay(0.5);
      GameTools.delay(1.5);
...
// GScene 2
      ...
      GameTools.delay(1);
      GameTools.typeText("\"A morsel... ", ConsoleColors.CYAN);
      GameTools.delay(1);
...
// GChoice 1
      ...
      switch (gChoice) {
         case "1" -> {
             ...
             GameTools.delay(0.5);
             GameTools.typeText("\nA searing pain blooms -", ConsoleColors.RED_BOLD);GameTools.delay(0.3);
             GameTools.typeText(" light flaring beneath your ribs.", ConsoleColors.RED_BOLD);
             GameTools.delay(0.5);
             ...
             GameTools.typeText("\n\nStatus effect: ", 100);
             GameTools.delay(0.3);
             GameTools.typeText("Wither", ConsoleColors.RED_BOLD, 100);
           }
         case "2" -> {
             ...
             GameTools.delay(0.5);
             GameTools.typeText("\n\n\"Liars!", ConsoleColors.RED_BOLD);
             GameTools.delay(0.5);
             GameTools.typeText(" Demons in light's clothing!", ConsoleColors.RED_BOLD);
             GameTools.typeText(" Your mercy is a disease!\"", ConsoleColors.RED_BOLD);
             GameTools.delay(0.7);
             GameTools.typeText("\n\nThe soul condemns you,");GameTools.delay(0.3);
             GameTools.typeText(" and its despair lashes out,");
             GameTools.delay(0.3);
             GameTools.typeText("\ntainting your wings with an unhealable withering.", ConsoleColors.RED);
             GameTools.delay(0.7);
         ...
         default -> {
               GameTools.typeText("Invalid choice. The indecision invites the taint regardless.", ConsoleColors.RED);
               GameState.setStatusEffectTaint(true);
               GameTools.typeText("\n\nStatus effect: Wither", ConsoleColors.RED_BOLD);
         }
      }
      GameTools.typeText("\n\nSin counter: " + GameState.getSinCounter(), ConsoleColors.RED);
      GameTools.pressToContinue(scanner);
...
// GScene 3
      ...
      GameTools.delay(0.5);
      GameTools.typeText("\n\nIts voice seeps through the cracks of your pain.", ConsoleColors.RED, 100);GameTools.delay(0.3);
      System.out.println();
      GameTools.delay(1);
      ...
      boolean secondRiddleSolved = false;
         ...
         GameTools.delay(0.7);
         GameTools.typeText("\"You reek of decay, ", ConsoleColors.RED); GameTools.delay(0.3);
      ...
      while (attempts < 3 && !secondRiddleSolved) {
         GameTools.typeText("\n\n\"When a soul feeds on everything,", ConsoleColors.CYAN);
         GameTools.delay(0.5);
         GameTools.typeText(" yet remains empty.\"", ConsoleColors.CYAN, 70);
         GameTools.delay(0.5);
         GameTools.typeText("\n\"What.", ConsoleColors.RED_BOLD, 100);
         GameTools.delay(0.5);
         GameTools.typeText(" Sin.", ConsoleColors.RED_BOLD, 100);
         GameTools.delay(0.5);
         GameTools.typeText(" Binds it?\"", ConsoleColors.RED_BOLD, 100);
         GameTools.delay(1);
         GameTools.typeText("\n(Attempt " + (attempts + 1) + "): ");
         String answer = scanner.nextLine();
         ...
         if (GameTools.checkRiddleAnswer(answer, riddle2Keywords) && attempts == 1) {
            ...
            attempts++;
             switch (attempts) {
                 case 1 -> {
                     GameTools.typeText("\n1st Attempt failed", ConsoleColors.RED);
                     System.out.println();
                     ...
                     GameTools.typeText("\n\n\"Try again,");
                     GameTools.delay(0.3);
                     GameTools.typeText(" before you are consumed.\"", ConsoleColors.RED);
                     GameTools.delay(1);
                 }
                 case 2 -> {
                     GameTools.typeText("\n2nd Attempt failed", ConsoleColors.RED);
                     System.out.println();
                     ...
                     GameTools.delay(0.5);
                     GameTools.typeText("\n\n\"One more failure", ConsoleColors.RED_BOLD, 100);
                     GameTools.delay(0.3);
                     GameTools.typeText(" and you will join the feasters below.\"", ConsoleColors.RED_BOLD, 100);
                     GameTools.delay(1);
                 }
                 default -> {
                     GameTools.typeText("\n3rd Attempt Failed You have failed and return to Limbo.", ConsoleColors.RED_BOLD);
                     System.out.println();
                     ...
                     GameTools.delay(0.5);
                     GameTools.typeText("\n\nYou wither away and join the Gluttonous in their endless supper.", ConsoleColors.RED, 70);
                     GameTools.delay(1);
                     GameState.setSinCounter(0);
